...
void write_batch64(unsigned int *array, uint32_t start, uint32_t end, uint16_t size) {
...
void write_bit(unsigned int *array, uint32_t bit) {
    uint8_t size_ull = sizeof(unsigned int) * 8;
 ...
 */
uint32_t read_most_significant_bit(unsigned long long *array, uint32_t start, uint16_t size) {
...
uint32_t read_end_batch64(unsigned int *array, uint32_t start, uint16_t size) {
    uint8_t size_ull = sizeof(unsigned int) * 8;
    unsigned int start_var = start/size_ull;
    //__sync_synchronize();
...
uint32_t read_batch64(unsigned int *array, uint32_t start, uint16_t size) {
    uint8_t size_ull = sizeof(unsigned int) * 8;
    unsigned int start_var = start/size_ull;
...
bool read_bit(unsigned int *array, unsigned int index)
{
    uint8_t size_ull = sizeof(unsigned int) * 8;
